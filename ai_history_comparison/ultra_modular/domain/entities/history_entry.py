...
Single responsibility: Represents a single AI history entry with all its
associated data and business rules.
"""
...
class HistoryEntry:
    ...
    def get_sentence_count(self) -> int:
        """Get sentence count from metrics."""
        return self.metrics.sentence_count or 0
