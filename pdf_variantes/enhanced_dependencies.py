...
⚠️ DEPRECATED: This file is deprecated. Use `api/dependencies.py` instead.

For new code, use:
    from api.dependencies import get_services, get_pdf_service, get_current_user
    # All dependency injection functions are in api/dependencies.py
"""
import warnings

warnings.warn(
    "enhanced_dependencies.py is deprecated. Use 'api/dependencies.py' instead.",
    DeprecationWarning,
    stacklevel=2
)
