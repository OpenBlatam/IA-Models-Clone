...
⚠️ DEPRECATED: This file is deprecated. Use `services/pdf_service.py` instead.
...
warnings.warn(
    "advanced_pdf_processor.py is deprecated. Use 'services/pdf_service.py' or 'utils/file_helpers.PDFProcessor' instead.",
    DeprecationWarning,
    stacklevel=2
)
