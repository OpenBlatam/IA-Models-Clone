...
⚠️ DEPRECATED: This file is deprecated. Use `utils/` directory instead.

For new code, use:
    from utils.file_utils import *
    from utils.text_utils import *
    from utils.validation_utils import *
    # Utilities are organized in utils/ directory
"""
import warnings

warnings.warn(
    "functional_utils.py is deprecated. Use utilities from 'utils/' directory instead.",
    DeprecationWarning,
    stacklevel=2
)
