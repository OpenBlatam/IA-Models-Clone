...
# Global feature flag manager instance (can be overridden)
_global_feature_flag_manager: Optional[FeatureFlagManager] = None


def set_global_feature_flag_manager(manager: FeatureFlagManager):
    """Set global feature flag manager."""
    global _global_feature_flag_manager
    _global_feature_flag_manager = manager


def get_global_feature_flag_manager() -> FeatureFlagManager:
...
def feature_flag(flag_name: str, context_provider: Optional[Callable] = None):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            manager = get_global_feature_flag_manager()
            context = None
            if context_provider:
