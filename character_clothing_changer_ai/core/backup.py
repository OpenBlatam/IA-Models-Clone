...
class BackupManager:
    ...
    def create_backup(self, source_dir: str, backup_name: Optional[str] = None, compress: bool = True) -> str:
        """
        ...
        backup_name = backup_name or f"{source_path.name}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
