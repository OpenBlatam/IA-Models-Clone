"""
Gamma App - Critical Improvements Engine
Only real, critical improvements that actually work
"""
...
class CriticalImprovementType(Enum):
    """Critical improvement types"""
    BUG_FIX = "bug_fix"
...
@dataclass
class CriticalImprovement:
    """Critical improvement representation"""
    improvement_id: str
    title: str
    description: str
    improvement_type: CriticalImprovementType
    effort_minutes: int
...
class CriticalImprovementsEngine:
    """
    Critical improvements engine for real, working improvements
    """
    
    def __init__(self):
        """Initialize critical improvements engine"""
        self.improvements: Dict[str, CriticalImprovement] = {}
        self.total_improvements = 0
        self.completed_improvements = 0
        
        # Load critical improvements that work
        self._load_critical_improvements()
    
    def _load_critical_improvements(self):
        """Load critical improvements that work"""
        ...
        for improvement_data in critical_improvements:
            self.create_improvement(
                title=improvement_data["title"],
                description=improvement_data["description"],
                improvement_type=CriticalImprovementType(improvement_data["type"]),
    ...
    def create_improvement(self, title: str, description: str, 
        ...
        try:
            ...
            improvement = CriticalImprovement(
    ...
    def get_improvements_by_type(self, improvement_type: CriticalImprovementType) -> List[CriticalImprovement]:
    ...
    def get_improvements_by_impact(self, impact: str) -> List[CriticalImprovement]:
            ...
            if "improvements" in data:
                for imp_data in data["improvements"]:
                    improvement = CriticalImprovement(
                        ...
                        improvement_type=CriticalImprovementType(imp_data["improvement_type"]),
...
# Global critical improvements engine instance
critical_improvements_engine = None

def get_critical_improvements_engine() -> CriticalImprovementsEngine:
    """Get critical improvements engine instance"""
    global critical_improvements_engine
    if not critical_improvements_engine:
        critical_improvements_engine = CriticalImprovementsEngine()
    return critical_improvements_engine
