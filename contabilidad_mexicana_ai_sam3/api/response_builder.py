"""
Response building utilities for Contador SAM3 API.

Refactored to consolidate response building patterns.
"""
...
class ResponseBuilder:
    ...
    Responsibilities:
    - Create task submission responses
    - Create health check responses
    
    Single Responsibility: Handle all response building operations.
    """
