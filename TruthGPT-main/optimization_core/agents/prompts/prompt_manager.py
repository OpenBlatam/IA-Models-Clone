...
class PromptManager:
    ...
    def _load_defaults(self):
        ...
        self._templates["react_core"] = (
            ...
            "Analyze the user request and decide if you need tools.\n"
            "If a local file path or directory is mentioned in the query, use the appropriate file operations tools (like file_read, directory_list, or glob_search) to read and inspect it.\n"
