    ...
    def execute_action(self, action: Action, context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            error_payload = {
                ...
                "action_id": action.action_id,
                "action_type": action.action_type.value,
                "suggestion": "Review action parameters and constraints."
            }
    ...
    def _execute_queued_actions(self):
        ...
        while not self.execution_module.action_queue.empty():
            try:
                ...
                self.execution_module.executor.submit(self._run_action_async, action)
            except queue.Empty:
                break
                
    def _run_action_async(self, action: Action):
        """Background worker to execute an action."""
        try:
