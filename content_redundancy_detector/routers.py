...
Please use the modular API routes from `api/routes/` instead.
...
Migration Status:
- 90+ endpoints (91%) have been migrated to modular routes
- ~9 endpoints remain (mostly duplicates)
- Legacy router available at `/api/v1/legacy` for backward compatibility
- Modular routes take precedence and are registered first

See `REFACTORING_COMPLETE_FINAL.md` for migration details.
"""
