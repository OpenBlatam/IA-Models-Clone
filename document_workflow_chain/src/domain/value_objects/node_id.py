"""
Node ID Value Object
===================

Immutable value object representing a node identifier.
"""
...
class NodeId:
    ...
    Immutable value object that represents a node identifier.
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.value, UUID):
            raise ValueError("NodeId must be a UUID")
