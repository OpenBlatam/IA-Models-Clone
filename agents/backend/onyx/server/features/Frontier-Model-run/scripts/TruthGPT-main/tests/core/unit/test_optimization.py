...
class TestOptimizationEngine(unittest.TestCase):
    ...
    def test_optimization_with_different_model_sizes(self):
        """Test optimization with different model sizes"""
        sizes = [
            (5, 3),    # Very small
            (20, 10),  # Small
            (50, 25),  # Medium
        ...
        for input_size, output_size in sizes:
            ...
            optimized = self.engine.optimize_model(model)
            self.assertIsNotNone(optimized)
        
        logger.info("✅ Optimization with different model sizes test passed")
    
    def test_optimization_state_management(self):
        """Test optimization state management"""
        # Optimize model multiple times
        optimized1 = self.engine.optimize_model(self.model)
        optimized2 = self.engine.optimize_model(self.model)
        
        # Both should be valid
        self.assertIsNotNone(optimized1)
        ...
        logger.info("✅ Optimization state management test passed")
    
    def test_optimization_error_handling(self):
        """Test optimization error handling"""
        # Test with None model
        try:
            result = self.engine.optimize_model(None)
        ...
        logger.info("✅ Optimization error handling test passed")
    
    def test_optimization_config_combinations(self):
        """Test different optimization config combinations"""
        combinations = [
            {'enable_memory_optimization': True},
            {'enable_quantization': True},
            {'enable_sparsity': True},
            {'enable_memory_optimization': True, 'enable_quantization': True},
            {'enable_memory_optimization': True, 'enable_sparsity': True},
        ]
        
        for combo in combinations:
            config = OptimizationConfig(level=OptimizationLevel.ENHANCED, **combo)
            engine = OptimizationEngine(config)
            optimized = engine.optimize_model(self.model)
            self.assertIsNotNone(optimized)
        
        logger.info("✅ Optimization config combinations test passed")
    
    def test_optimization_metrics_tracking(self):
        """Test optimization metrics tracking"""
        # Perform multiple optimizations
        for _ in range(3):
            self.engine.optimize_model(self.model)
        
        metrics = self.engine.get_performance_metrics()
        self.assertIsNotNone(metrics)
        self.assertGreaterEqual(metrics.get('optimization_count', 0), 3)
        
        logger.info("✅ Optimization metrics tracking test passed")
    
    def test_optimization_with_custom_settings(self):
        ...
        logger.info("✅ Optimization with custom settings test passed")
