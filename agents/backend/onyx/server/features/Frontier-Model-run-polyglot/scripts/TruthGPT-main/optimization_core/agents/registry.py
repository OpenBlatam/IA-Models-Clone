...
class ComponentRegistry:
    ...
    def _init_builtins(self) -> None:
        ...
        from .system_intelligence.system_tools import (
            ...
            GoogleScholarSearchTool, GitHubSearchTool, SOTAPaperScraperTool
        )
        ...
        self._tools = {
            ...
            "sota_scraper": SOTAPaperScraperTool,
        }
        ...
        self._agents = {
            ...
            "forensic_agent": SystemAgent,
            "data_analysis": DataAnalysisAgent,
            "arxiv_discovery_scout": ResearchAgent,
