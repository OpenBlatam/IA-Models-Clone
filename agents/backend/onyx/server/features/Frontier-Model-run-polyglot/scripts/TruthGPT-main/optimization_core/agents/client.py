...
class AgentClient:
    ...
    def _ensure_default_agents_registered(self) -> None:
        ...
        try:
            ...
            registry.register_agent("forensic_agent", SystemAgent)
            
            # New Industrial Specialized Agents
            from .multi_agentes.planning_agent import PlanningAgent
            registry.register_agent("planning_agent", PlanningAgent)
            
            from .code_interpreter import CodeInterpreterAgent as CodeArchitectAgent
            registry.register_agent("code_architect", CodeArchitectAgent)
            
            from .blockchain.blockchain_agent import BlockchainAgent
            registry.register_agent("blockchain_agent", BlockchainAgent)
