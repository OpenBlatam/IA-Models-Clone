...
if _papers_source.exists():
    try:
        ...
        try:
            ...
            try:
                from core.metadata_extractor import MetadataExtractor, PaperMetadata as SourcePaperMetadata
                from core.paper_registry_refactored import PaperRegistryRefactored, PaperModule as SourcePaperModule
                _PAPERS_AVAILABLE = True
