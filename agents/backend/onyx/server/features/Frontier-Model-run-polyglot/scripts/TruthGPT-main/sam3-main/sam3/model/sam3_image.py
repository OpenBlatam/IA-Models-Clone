...
class Sam3Image(torch.nn.Module):
    ...
    def _compute_class_scores(self, scoring_head, hs, prompt, prompt_mask):
        ...
        Args:
            scoring_head: The scoring head module
            hs: Hidden states
            prompt: Prompt embeddings
    ...
    def _should_postprocess_multimask(self, out: Dict, multimask_output: bool) -> bool:
        ...
        Args:
            ...
            multimask_output: Whether multimask output is enabled
            
        Returns:
            True if postprocessing should be applied
        """
        return (
            not self.training
    ...
    def _save_multimask_outputs(self, out: Dict) -> None:
        ...
        Args:
            out: Output dictionary to modify
        """
    ...
    def _select_best_mask(self, out: Dict) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        Returns:
            Tuple of (best_mask_idx, batch_idx)
        """
    ...
    def _apply_best_mask_selection(
        ...
        Args:
            out: Output dictionary to modify
            best_mask_idx: Indices of best masks
    ...
    def _postprocess_out(self, out: Dict, multimask_output: bool = False):
        ...
        For multimask output, during eval we return the single best mask with
        the dict keys expected by the evaluators, but also return the multimasks
        output with new keys.
        ...
        Returns:
            Postprocessed output dictionary
        """
