...
from unified_core.connectors.confluence.connector import ConfluenceCheckpoint
from unified_core.connectors.confluence.connector import ConfluenceConnector
...
def confluence_connector(
    ...
    with patch("unified_core.connectors.confluence.connector._SLIM_DOC_BATCH_SIZE", 2):
        yield connector
...
def test_load_from_checkpoint_with_page_processing_error(
    ...
    with patch(
        "unified_core.connectors.confluence.connector.ConfluenceConnector._convert_page_to_document",
