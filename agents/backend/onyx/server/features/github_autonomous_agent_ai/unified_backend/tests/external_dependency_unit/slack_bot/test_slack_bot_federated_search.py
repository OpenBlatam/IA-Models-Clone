...
from unified_core.db.models import Persona__DocumentSet
from unified_core.db.models import Persona__Tool
...
from unified_core.onyxbot.slack.listener import process_message
from unified_core.onyxbot.slack.models import ChannelType
from unified_core.db.tools import get_builtin_tool
from unified_core.tools.built_in_tools import SearchTool
...
class TestSlackBotFederatedSearch:
    ...
    def _setup_slack_mocks(self, channel_name: str) -> tuple[list, list]:
        ...
        patches = [
            ...
            patch("unified_core.context.search.federated.slack_search.query_slack"),
            patch("unified_core.onyxbot.slack.listener.get_channel_type_from_id"),
            patch("unified_core.context.search.utils.get_query_embeddings"),
        ]
    ...
    @patch("unified_core.utils.gpu_utils.fast_gpu_status_request", return_value=False)
    @patch(
        "unified_core.document_index.vespa.index.VespaIndex.hybrid_retrieval", return_value=[]
    )
