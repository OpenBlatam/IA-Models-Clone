...
from unified_core.connectors.factory import _connector_cache
from unified_core.connectors.factory import _load_connector_class
from unified_core.connectors.factory import ConnectorMissingException
from unified_core.connectors.factory import identify_connector_class
...
from unified_core.connectors.registry import ConnectorMapping
...
class TestConnectorClassLoading:
    ...
    def test_load_connector_class_import_error(self, mock_import: Mock) -> None:
        ...
        assert (
            "Failed to import WebConnector from unified_core.connectors.web.connector"
