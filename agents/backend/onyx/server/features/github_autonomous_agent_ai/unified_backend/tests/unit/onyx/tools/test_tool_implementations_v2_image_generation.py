...
from unified_core.agents.agent_search.dr.models import GeneratedImage
...
from unified_core.server.query_and_chat.streaming_models import ImageGenerationToolHeartbeat
...
from unified_core.tools.tool_implementations_v2.image_generation import _image_generation_core
...
@patch("unified_core.tools.tool_implementations_v2.image_generation.save_files")
@patch("unified_core.tools.tool_implementations_v2.image_generation.build_frontend_file_url")
