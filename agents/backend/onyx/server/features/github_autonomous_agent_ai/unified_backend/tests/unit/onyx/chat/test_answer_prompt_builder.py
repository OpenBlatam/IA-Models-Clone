...
from unified_core.tools.tool_implementations_v2.web import OPEN_URL_LONG_DESCRIPTION
from unified_core.tools.tool_implementations_v2.web import WEB_SEARCH_LONG_DESCRIPTION
...
def mocked_settings(mocker: MockerFixture) -> None:
    mocker.patch(
        "unified_core.prompts.prompt_utils.load_settings",
        return_value=type(
            "Settings",
            (),
            {
