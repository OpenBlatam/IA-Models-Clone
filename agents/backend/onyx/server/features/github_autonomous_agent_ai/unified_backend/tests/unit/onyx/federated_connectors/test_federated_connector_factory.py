...
from unified_core.federated_connectors.factory import _federated_connector_cache
from unified_core.federated_connectors.factory import _load_federated_connector_class
from unified_core.federated_connectors.factory import FederatedConnectorMissingException
...
from unified_core.federated_connectors.registry import FEDERATED_CONNECTOR_CLASS_MAP
from unified_core.federated_connectors.registry import FederatedConnectorMapping
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in FEDERATED_CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith(
                "unified_core.federated_connectors."
...
class TestFederatedConnectorClassLoading:
    ...
    def test_load_federated_connector_class_import_error(
        ...
        assert (
            "Failed to import SlackFederatedConnector from unified_core.federated_connectors.slack.federated_connector"
