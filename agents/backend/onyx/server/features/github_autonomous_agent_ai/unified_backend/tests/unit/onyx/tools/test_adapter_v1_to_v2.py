...
from unified_core.db.models import MCPServer
from unified_core.tools.adapter_v1_to_v2 import custom_or_mcp_tool_to_function_tool
...
@patch("unified_core.tools.tool_implementations.custom.custom_tool.requests.request")
...
@patch("unified_core.tools.tool_implementations.mcp.mcp_tool.call_mcp_tool")
...
def test_custom_tool_csv_response_with_file_ids(
    ...
    with patch(
        "unified_core.tools.tool_implementations.custom.custom_tool.get_default_file_store"
