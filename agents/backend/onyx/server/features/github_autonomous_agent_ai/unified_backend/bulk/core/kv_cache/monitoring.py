...
from kv_cache.types import StatsDict, MetricsDict
from kv_cache.constants import DEFAULT_WINDOW_SIZE, DEFAULT_LOW_HIT_RATE_THRESHOLD, DEFAULT_HIGH_MEMORY_MB_THRESHOLD
...
class CacheMonitor:
    ...
    def __init__(
        ...
        self.alert_thresholds = alert_thresholds or {
            "hit_rate": DEFAULT_LOW_HIT_RATE_THRESHOLD,
            "memory_usage_mb": DEFAULT_HIGH_MEMORY_MB_THRESHOLD,
        }
        
        # Metrics history
        self._metrics_history: deque[CacheMetrics] = deque(maxlen=window_size)
        self._operation_times: deque[float] = deque(maxlen=window_size)
        
        # Current state
        self._last_metrics: CacheMetrics | None = None
    ...
    def get_current_metrics(self) -> CacheMetrics | None:
        """Get current metrics."""
    ...
    def get_summary(self) -> StatsDict:
...
class MetricsExporter:
    ...
    @staticmethod
    def export_to_dict(monitor: CacheMonitor) -> StatsDict:
