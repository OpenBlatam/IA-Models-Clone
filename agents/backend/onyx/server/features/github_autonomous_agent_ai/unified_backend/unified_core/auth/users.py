...
from unified_core.auth.api_key import get_hashed_api_key_from_request
from unified_core.auth.email_utils import send_forgot_password_email
from unified_core.auth.email_utils import send_user_verification_email
...
from unified_core.auth.jwt import verify_jwt_token
from unified_core.auth.schemas import AuthBackend
from unified_core.auth.schemas import UserCreate
from unified_core.auth.schemas import UserRole
from unified_core.auth.schemas import UserUpdateWithRole
from unified_core.configs.app_configs import AUTH_BACKEND
from unified_core.configs.app_configs import AUTH_COOKIE_EXPIRE_TIME_SECONDS
from unified_core.configs.app_configs import AUTH_TYPE
from unified_core.configs.app_configs import DISABLE_AUTH
from unified_core.configs.app_configs import EMAIL_CONFIGURED
from unified_core.configs.app_configs import JWT_PUBLIC_KEY_URL
from unified_core.configs.app_configs import PASSWORD_MAX_LENGTH
from unified_core.configs.app_configs import PASSWORD_MIN_LENGTH
from unified_core.configs.app_configs import PASSWORD_REQUIRE_DIGIT
from unified_core.configs.app_configs import PASSWORD_REQUIRE_LOWERCASE
from unified_core.configs.app_configs import PASSWORD_REQUIRE_SPECIAL_CHAR
from unified_core.configs.app_configs import PASSWORD_REQUIRE_UPPERCASE
from unified_core.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from unified_core.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from unified_core.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from unified_core.configs.app_configs import TRACK_EXTERNAL_IDP_EXPIRY
...
from unified_core.configs.constants import ANONYMOUS_USER_COOKIE_NAME
from unified_core.configs.constants import AuthType
from unified_core.configs.constants import DANSWER_API_KEY_DUMMY_EMAIL_DOMAIN
from unified_core.configs.constants import DANSWER_API_KEY_PREFIX
...
from unified_core.configs.constants import PASSWORD_SPECIAL_CHARS
from unified_core.configs.constants import UNNAMED_KEY_PLACEHOLDER
from unified_core.db.api_key import fetch_user_for_api_key
from unified_core.db.auth import get_access_token_db
from unified_core.db.auth import get_default_admin_user_emails
from unified_core.db.auth import get_user_count
from unified_core.db.auth import get_user_db
from unified_core.db.auth import SQLAlchemyUserAdminDB
from unified_core.db.engine.async_sql_engine import get_async_session
from unified_core.db.engine.async_sql_engine import get_async_session_context_manager
from unified_core.db.engine.sql_engine import get_session_with_tenant
from unified_core.db.models import AccessToken
from unified_core.db.models import OAuthAccount
from unified_core.db.models import Persona
from unified_core.db.models import User
from unified_core.db.saml import get_saml_account
from unified_core.db.users import get_user_by_email
from unified_core.redis.redis_pool import get_async_redis_connection
...
from unified_core.utils.secrets import extract_hashed_cookie
...
from unified_core.utils.url import add_url_params
...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def create(
        ...
        tenant_id = await fetch_ee_implementation_or_noop(
            "unified_core.server.tenants.provisioning",
...
class FastAPIUserWithLogoutRouter(FastAPIUsers[models.UP, models.ID]):
    ...
    def get_refresh_router(
        ...
        from unified_core.auth.oauth_refresher import check_and_refresh_oauth_tokens
