...
from unified_core.db.models import Project__UserFile
...
from unified_core.server.documents.connector import upload_files
from unified_core.server.features.projects.projects_file_utils import categorize_uploaded_files
