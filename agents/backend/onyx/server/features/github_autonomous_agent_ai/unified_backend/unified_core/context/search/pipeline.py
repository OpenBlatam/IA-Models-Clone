...
from unified_core.chat.models import ContextualPruningConfig
from unified_core.chat.models import PromptConfig
from unified_core.chat.models import SectionRelevancePiece
from unified_core.chat.prune_and_merge import _merge_sections
from unified_core.chat.prune_and_merge import ChunkRange
from unified_core.chat.prune_and_merge import merge_chunk_intervals
from unified_core.chat.prune_and_merge import prune_and_merge_sections
from unified_core.configs.chat_configs import DISABLE_LLM_DOC_RELEVANCE
from unified_core.context.search.enums import LLMEvaluationType
from unified_core.context.search.enums import QueryFlow
from unified_core.context.search.enums import SearchType
from unified_core.context.search.models import IndexFilters
from unified_core.context.search.models import InferenceChunk
from unified_core.context.search.models import InferenceSection
from unified_core.context.search.models import RerankMetricsContainer
from unified_core.context.search.models import RetrievalMetricsContainer
from unified_core.context.search.models import SearchQuery
from unified_core.context.search.models import SearchRequest
from unified_core.context.search.postprocessing.postprocessing import cleanup_chunks
from unified_core.context.search.postprocessing.postprocessing import search_postprocessing
from unified_core.context.search.preprocessing.preprocessing import retrieval_preprocessing
from unified_core.context.search.retrieval.search_runner import (
    retrieve_chunks,
)
from unified_core.context.search.utils import inference_section_from_chunks
from unified_core.context.search.utils import relevant_sections_to_indices
...
from unified_core.secondary_llm_flows.agentic_evaluation import evaluate_inference_section
...
class SearchPipeline:
    ...
    def _get_sections(self) -> list[InferenceSection]:
        ...
        censored_chunks: list[InferenceChunk] = fetch_ee_implementation_or_noop(
            "unified_core.external_permissions.post_query_censoring",
