...
from unified_core.configs.app_configs import IMAGE_SUMMARIZATION_SYSTEM_PROMPT
from unified_core.configs.app_configs import IMAGE_SUMMARIZATION_USER_PROMPT
