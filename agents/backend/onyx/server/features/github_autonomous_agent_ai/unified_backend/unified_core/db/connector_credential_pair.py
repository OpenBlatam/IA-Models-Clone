...
from unified_core.configs.app_configs import USER_FILE_INDEXING_LIMIT
...
from unified_core.db.models import UserGroup__ConnectorCredentialPair
...
def add_credential_to_connector(
    ...
    if access_type == AccessType.SYNC:
        if not fetch_ee_implementation_or_noop(
            "unified_core.external_permissions.sync_params",
