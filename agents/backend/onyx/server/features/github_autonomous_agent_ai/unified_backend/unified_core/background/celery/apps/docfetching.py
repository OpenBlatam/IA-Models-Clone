...
from unified_core.configs.constants import POSTGRES_CELERY_WORKER_DOCFETCHING_APP_NAME
...
celery_app.config_from_object("unified_core.background.celery.configs.docfetching")
