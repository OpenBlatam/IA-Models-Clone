...
from unified_core.chat.models import ThreadMessage
from unified_core.configs.app_configs import DEV_MODE
from unified_core.configs.app_configs import POD_NAME
from unified_core.configs.app_configs import POD_NAMESPACE
from unified_core.configs.constants import MessageType
from unified_core.configs.constants import OnyxRedisLocks
from unified_core.configs.onyxbot_configs import NOTIFY_SLACKBOT_NO_ANSWER
from unified_core.configs.onyxbot_configs import ONYX_BOT_REPHRASE_MESSAGE
from unified_core.configs.onyxbot_configs import ONYX_BOT_RESPOND_EVERY_CHANNEL
from unified_core.connectors.slack.utils import expert_info_from_slack_id
...
from unified_core.db.engine.tenant_utils import get_all_tenant_ids
from unified_core.db.models import SlackBot
from unified_core.db.search_settings import get_current_search_settings
from unified_core.db.slack_bot import fetch_slack_bot
from unified_core.db.slack_bot import fetch_slack_bots
...
from unified_core.onyxbot.slack.config import get_slack_channel_config_for_bot_and_channel
from unified_core.onyxbot.slack.config import MAX_TENANTS_PER_POD
from unified_core.onyxbot.slack.config import TENANT_ACQUISITION_INTERVAL
from unified_core.onyxbot.slack.config import TENANT_HEARTBEAT_EXPIRATION
from unified_core.onyxbot.slack.config import TENANT_HEARTBEAT_INTERVAL
from unified_core.onyxbot.slack.config import TENANT_LOCK_EXPIRATION
from unified_core.onyxbot.slack.constants import DISLIKE_BLOCK_ACTION_ID
from unified_core.onyxbot.slack.constants import FEEDBACK_DOC_BUTTON_BLOCK_ACTION_ID
from unified_core.onyxbot.slack.constants import FOLLOWUP_BUTTON_ACTION_ID
from unified_core.onyxbot.slack.constants import FOLLOWUP_BUTTON_RESOLVED_ACTION_ID
from unified_core.onyxbot.slack.constants import GENERATE_ANSWER_BUTTON_ACTION_ID
from unified_core.onyxbot.slack.constants import IMMEDIATE_RESOLVED_BUTTON_ACTION_ID
from unified_core.onyxbot.slack.constants import KEEP_TO_YOURSELF_ACTION_ID
from unified_core.onyxbot.slack.constants import LIKE_BLOCK_ACTION_ID
from unified_core.onyxbot.slack.constants import SHOW_EVERYONE_ACTION_ID
from unified_core.onyxbot.slack.constants import VIEW_DOC_FEEDBACK_ID
from unified_core.onyxbot.slack.handlers.handle_buttons import handle_doc_feedback_button
from unified_core.onyxbot.slack.handlers.handle_buttons import handle_followup_button
from unified_core.onyxbot.slack.handlers.handle_buttons import (
...
from unified_core.onyxbot.slack.handlers.handle_buttons import handle_slack_feedback
from unified_core.onyxbot.slack.handlers.handle_message import handle_message
from unified_core.onyxbot.slack.handlers.handle_message import (
    remove_scheduled_feedback_reminder,
)
from unified_core.onyxbot.slack.handlers.handle_message import schedule_feedback_reminder
from unified_core.onyxbot.slack.models import SlackContext
from unified_core.onyxbot.slack.models import SlackMessageInfo
from unified_core.onyxbot.slack.utils import check_message_limit
from unified_core.onyxbot.slack.utils import decompose_action_id
from unified_core.onyxbot.slack.utils import get_channel_name_from_id
from unified_core.onyxbot.slack.utils import get_channel_type_from_id
from unified_core.onyxbot.slack.utils import get_onyx_bot_auth_ids
from unified_core.onyxbot.slack.utils import read_slack_thread
from unified_core.onyxbot.slack.utils import remove_onyx_bot_tag
from unified_core.onyxbot.slack.utils import rephrase_slack_message
from unified_core.onyxbot.slack.utils import respond_in_thread_or_channel
from unified_core.onyxbot.slack.utils import TenantSocketModeClient
from unified_core.redis.redis_pool import get_redis_client
from unified_core.server.manage.models import SlackBotTokens
...
class SlackbotHandler:
    ...
    def acquire_tenants(self) -> None:
        ...
        gated_tenants = fetch_ee_implementation_or_noop(
            "unified_core.server.tenants.product_gating",
            "get_gated_tenants",
            set(),
        )()
        all_active_tenants = [
