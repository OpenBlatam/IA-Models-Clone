...
from unified_core.db.constants import DEFAULT_PERSONA_SLACK_CHANNEL_NAME
...
from unified_core.db.persona import upsert_persona
...
from unified_core.utils.errors import EERequiredError
...
def insert_slack_channel_config(
    ...
    versioned_fetch_standard_answer_categories_by_ids = (
        fetch_versioned_implementation_with_fallback(
            "unified_core.db.standard_answer",
