...
from unified_core.access.access import get_access_for_document
from unified_core.background.celery.apps.app_base import task_logger
from unified_core.background.celery.tasks.shared.RetryDocumentIndex import RetryDocumentIndex
from unified_core.background.celery.tasks.shared.tasks import LIGHT_SOFT_TIME_LIMIT
from unified_core.background.celery.tasks.shared.tasks import LIGHT_TIME_LIMIT
from unified_core.background.celery.tasks.shared.tasks import OnyxCeleryTaskCompletionStatus
from unified_core.background.celery.tasks.vespa.document_sync import DOCUMENT_SYNC_FENCE_KEY
from unified_core.background.celery.tasks.vespa.document_sync import get_document_sync_payload
from unified_core.background.celery.tasks.vespa.document_sync import get_document_sync_remaining
from unified_core.background.celery.tasks.vespa.document_sync import reset_document_sync
from unified_core.background.celery.tasks.vespa.document_sync import (
    try_generate_stale_document_sync_tasks,
)
from unified_core.configs.app_configs import JOB_TIMEOUT
from unified_core.configs.app_configs import VESPA_SYNC_MAX_TASKS
from unified_core.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT
...
from unified_core.db.document import get_document
from unified_core.db.document import mark_document_as_synced
from unified_core.db.document_set import delete_document_set
from unified_core.db.document_set import fetch_document_sets
from unified_core.db.document_set import fetch_document_sets_for_document
from unified_core.db.document_set import get_document_set_by_id
from unified_core.db.document_set import mark_document_set_as_synced
...
from unified_core.db.models import DocumentSet
from unified_core.db.models import UserGroup
from unified_core.db.search_settings import get_active_search_settings
from unified_core.db.sync_record import cleanup_sync_records
...
from unified_core.redis.redis_document_set import RedisDocumentSet
...
from unified_core.redis.redis_usergroup import RedisUserGroup
...
from unified_core.utils.variable_functionality import noop_fallback
        ...
        if global_version.is_ee_version():
            try:
                fetch_user_groups = fetch_versioned_implementation(
                    "unified_core.db.user_group", "fetch_user_groups"
                )
        ...
        for key in keys:
            ...
            if key_str == DOCUMENT_SYNC_FENCE_KEY:
                ...
                monitor_usergroup_taskset = (
                    fetch_versioned_implementation_with_fallback(
                        "unified_core.background.celery.tasks.vespa.tasks",
                        "monitor_usergroup_taskset",
                        noop_fallback,
                    )
                )
...
def try_generate_user_group_sync_tasks(
    ...
    fetch_user_group = cast(
        ...
        fetch_versioned_implementation("unified_core.db.user_group", "fetch_user_group"),
    )
