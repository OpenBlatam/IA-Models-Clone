...
from unified_core.background.celery.celery_utils import celery_is_worker_primary
from unified_core.background.celery.tasks.vespa.document_sync import reset_document_sync
from unified_core.configs.app_configs import CELERY_WORKER_PRIMARY_POOL_OVERFLOW
from unified_core.configs.constants import CELERY_PRIMARY_WORKER_LOCK_TIMEOUT
from unified_core.configs.constants import OnyxRedisConstants
from unified_core.configs.constants import OnyxRedisLocks
from unified_core.configs.constants import POSTGRES_CELERY_WORKER_PRIMARY_APP_NAME
...
from unified_core.redis.redis_connector_ext_group_sync import RedisConnectorExternalGroupSync
from unified_core.redis.redis_connector_prune import RedisConnectorPrune
from unified_core.redis.redis_connector_stop import RedisConnectorStop
...
celery_app.config_from_object("unified_core.background.celery.configs.primary")
...
celery_app.autodiscover_tasks(
    [
        "unified_core.background.celery.tasks.connector_deletion",
        "unified_core.background.celery.tasks.docprocessing",
        "unified_core.background.celery.tasks.evals",
        "unified_core.background.celery.tasks.periodic",
        "unified_core.background.celery.tasks.pruning",
        "unified_core.background.celery.tasks.shared",
        "unified_core.background.celery.tasks.vespa",
        "unified_core.background.celery.tasks.llm_model_update",
        "unified_core.background.celery.tasks.kg_processing",
        "unified_core.background.celery.tasks.user_file_processing",
    ]
)
