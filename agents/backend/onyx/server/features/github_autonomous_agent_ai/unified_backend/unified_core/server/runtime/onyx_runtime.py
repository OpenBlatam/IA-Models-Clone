...
from unified_core.background.celery.tasks.beat_schedule import (
    CLOUD_DOC_PERMISSION_SYNC_MULTIPLIER_DEFAULT,
)
from unified_core.configs.constants import CLOUD_BUILD_FENCE_LOOKUP_TABLE_INTERVAL_DEFAULT
from unified_core.configs.constants import ONYX_CLOUD_REDIS_RUNTIME
from unified_core.configs.constants import ONYX_CLOUD_TENANT_ID
from unified_core.configs.constants import ONYX_EMAILABLE_LOGO_MAX_DIM
...
from unified_core.utils.file import OnyxStaticFileManager
...
class OnyxRuntime:
    ...
    def get_logo() -> FileWithMimeType:
        ...
        db_filename: str | None = fetch_ee_implementation_or_noop(
            "unified_core.server.enterprise_settings.store", "get_logo_filename", None
        )
    ...
    def get_logotype() -> FileWithMimeType:
        ...
        db_filename: str | None = fetch_ee_implementation_or_noop(
            "unified_core.server.enterprise_settings.store", "get_logotype_filename", None
        )
