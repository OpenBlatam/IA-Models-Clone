...
from unified_core.configs.app_configs import CONFLUENCE_CONNECTOR_USER_PROFILES_OVERRIDE
from unified_core.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_ID
from unified_core.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_SECRET
from unified_core.connectors.confluence.models import ConfluenceUser
from unified_core.connectors.confluence.user_profile_override import (
    process_confluence_user_profiles_override,
)
from unified_core.connectors.confluence.utils import _handle_http_error
from unified_core.connectors.confluence.utils import confluence_refresh_tokens
from unified_core.connectors.confluence.utils import get_start_param_from_url
from unified_core.connectors.confluence.utils import update_param_in_path
from unified_core.connectors.cross_connector_utils.miscellaneous_utils import scoped_url
from unified_core.connectors.interfaces import CredentialsProviderInterface
from unified_core.file_processing.html_utils import format_document_soup
