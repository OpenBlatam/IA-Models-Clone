...
from unified_core.chat.prompt_builder.utils import translate_history_to_basemessages
from unified_core.file_store.models import InMemoryChatFile
from unified_core.llm.interfaces import LLMConfig
from unified_core.llm.llm_provider_options import OPENAI_PROVIDER_NAME
from unified_core.llm.models import PreviousMessage
from unified_core.llm.utils import build_content_with_imgs
from unified_core.llm.utils import check_message_tokens
from unified_core.llm.utils import message_to_prompt_and_imgs
...
from unified_core.prompts.chat_prompts import CHAT_USER_CONTEXT_FREE_PROMPT
from unified_core.prompts.chat_prompts import CODE_BLOCK_MARKDOWN
from unified_core.prompts.chat_prompts import CUSTOM_INSTRUCTIONS_PROMPT
from unified_core.prompts.chat_prompts import DEFAULT_SYSTEM_PROMPT
from unified_core.prompts.chat_prompts import LONG_CONVERSATION_REMINDER_PROMPT
from unified_core.prompts.chat_prompts import TOOL_PERSISTENCE_PROMPT
from unified_core.prompts.direct_qa_prompts import HISTORY_BLOCK
from unified_core.prompts.prompt_utils import drop_messages_history_overflow
...
from unified_core.prompts.prompt_utils import handle_onyx_date_awareness
from unified_core.tools.force import ForceUseTool
from unified_core.tools.models import ToolCallFinalResult
from unified_core.tools.models import ToolCallKickoff
    ...
    if tools:
        ...
        for tool in tools:
            if type(tool).__name__ == "WebSearchTool":
                ...
                from unified_core.tools.tool_implementations_v2.web import (
