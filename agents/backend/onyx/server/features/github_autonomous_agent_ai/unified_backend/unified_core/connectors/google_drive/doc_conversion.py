...
from unified_core.connectors.google_drive.constants import DRIVE_FOLDER_TYPE
from unified_core.connectors.google_drive.constants import DRIVE_SHORTCUT_TYPE
from unified_core.connectors.google_drive.models import GDriveMimeType
from unified_core.connectors.google_drive.models import GoogleDriveFileType
from unified_core.connectors.google_drive.section_extraction import get_document_sections
from unified_core.connectors.google_drive.section_extraction import HEADING_DELIMITER
from unified_core.connectors.google_utils.resources import get_drive_service
from unified_core.connectors.google_utils.resources import get_google_docs_service
from unified_core.connectors.google_utils.resources import GoogleDocsService
...
from unified_core.file_processing.extract_file_text import ALL_ACCEPTED_FILE_EXTENSIONS
from unified_core.file_processing.extract_file_text import docx_to_text_and_images
from unified_core.file_processing.extract_file_text import extract_file_text
from unified_core.file_processing.extract_file_text import get_file_ext
from unified_core.file_processing.extract_file_text import pptx_to_text
from unified_core.file_processing.extract_file_text import read_pdf_file
from unified_core.file_processing.extract_file_text import xlsx_to_text
from unified_core.file_processing.file_validation import is_valid_image_type
from unified_core.file_processing.image_utils import store_image_and_create_section
...
def _get_external_access_for_raw_gdrive_file(
    ...
    external_access_fn = cast(
        ...
        fetch_versioned_implementation_with_fallback(
            "unified_core.external_permissions.google_drive.doc_sync",
