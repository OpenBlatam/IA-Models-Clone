...
from unified_core.configs.app_configs import DEFAULT_CONTEXTUAL_RAG_LLM_NAME
from unified_core.configs.app_configs import DEFAULT_CONTEXTUAL_RAG_LLM_PROVIDER
from unified_core.configs.app_configs import ENABLE_CONTEXTUAL_RAG
from unified_core.configs.app_configs import MAX_DOCUMENT_CHARS
from unified_core.configs.app_configs import MAX_TOKENS_FOR_FULL_INCLUSION
from unified_core.configs.app_configs import USE_CHUNK_SUMMARY
from unified_core.configs.app_configs import USE_DOCUMENT_SUMMARY
from unified_core.configs.llm_configs import get_image_extraction_and_analysis_enabled
from unified_core.configs.model_configs import USE_INFORMATION_CONTENT_CLASSIFICATION
from unified_core.connectors.cross_connector_utils.miscellaneous_utils import (
...
from unified_core.connectors.models import DocumentFailure
from unified_core.connectors.models import ImageSection
from unified_core.connectors.models import IndexAttemptMetadata
from unified_core.connectors.models import IndexingDocument
from unified_core.connectors.models import Section
from unified_core.connectors.models import TextSection
from unified_core.db.document import get_documents_by_ids
from unified_core.db.document import upsert_document_by_connector_credential_pair
from unified_core.db.document import upsert_documents
from unified_core.db.models import Document as DBDocument
from unified_core.db.models import IndexModelStatus
from unified_core.db.search_settings import get_active_search_settings
from unified_core.db.tag import upsert_document_tags
from unified_core.document_index.document_index_utils import (
    get_multipass_config,
)
from unified_core.document_index.interfaces import DocumentIndex
from unified_core.document_index.interfaces import DocumentMetadata
from unified_core.document_index.interfaces import IndexBatchParams
from unified_core.file_processing.image_summarization import summarize_image_with_error_handling
from unified_core.file_store.file_store import get_default_file_store
from unified_core.indexing.chunker import Chunker
from unified_core.indexing.embedder import embed_chunks_with_failure_handling
from unified_core.indexing.embedder import IndexingEmbedder
from unified_core.indexing.models import DocAwareChunk
from unified_core.indexing.models import IndexChunk
from unified_core.indexing.models import IndexingBatchAdapter
from unified_core.indexing.models import UpdatableChunkData
from unified_core.indexing.vector_db_insertion import write_chunks_to_vector_db_with_backoff
from unified_core.llm.chat_llm import LLMRateLimitError
from unified_core.llm.factory import get_default_llm_with_vision
from unified_core.llm.factory import get_llm_for_contextual_rag
from unified_core.llm.interfaces import LLM
from unified_core.llm.utils import MAX_CONTEXT_TOKENS
...
from unified_core.natural_language_processing.utils import tokenizer_trim_middle
from unified_core.prompts.chat_prompts import CONTEXTUAL_RAG_PROMPT1
from unified_core.prompts.chat_prompts import CONTEXTUAL_RAG_PROMPT2
from unified_core.prompts.chat_prompts import DOCUMENT_SUMMARY_PROMPT
