from unified_core.db.document import get_document_kg_entities_and_relationships
...
from unified_core.document_index.vespa.index import KGUChunkUpdateRequest
