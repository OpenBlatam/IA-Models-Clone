...
from unified_core.chat.models import RetrievalDocs
...
class SyncChatStateRequest(BaseModel):
    """Request to sync chat state from frontend (for robust persistence)"""
    chat_session_id: UUID
    message_tree: list[tuple[int, dict[str, Any]]]  # Array of [nodeId, Message] tuples
    chat_state: str
    metadata: dict[str, Any] | None = None


class SyncChatStateResponse(BaseModel):
    """Response for chat state sync"""
    success: bool
    chat_session_id: UUID
    synced_at: datetime
