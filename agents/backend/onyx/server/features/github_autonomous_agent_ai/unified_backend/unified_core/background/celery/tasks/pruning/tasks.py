...
from unified_core.background.celery.celery_utils import extract_ids_from_runnable_connector
from unified_core.background.celery.tasks.beat_schedule import CLOUD_BEAT_MULTIPLIER_DEFAULT
from unified_core.background.celery.tasks.docprocessing.utils import IndexingCallbackBase
from unified_core.configs.app_configs import ALLOW_SIMULTANEOUS_PRUNING
...
from unified_core.configs.constants import CELERY_PRUNING_LOCK_TIMEOUT
...
from unified_core.connectors.models import InputType
from unified_core.db.connector import mark_ccpair_as_pruned
...
from unified_core.db.document import get_documents_for_connector_credential_pair
...
from unified_core.db.tag import delete_orphan_tags__no_commit
from unified_core.redis.redis_connector import RedisConnector
from unified_core.redis.redis_connector_prune import RedisConnectorPrune
from unified_core.redis.redis_connector_prune import RedisConnectorPrunePayload
...
from unified_core.utils.logger import pruning_ctx
