...
from unified_core.auth.users import current_admin_user
from unified_core.auth.users import current_chat_accessible_user
from unified_core.auth.users import current_curator_or_admin_user
from unified_core.auth.users import current_user
from unified_core.background.celery.versioned_apps.client import app as client_app
from unified_core.configs.app_configs import DISABLE_AUTH
from unified_core.configs.app_configs import ENABLED_CONNECTOR_TYPES
from unified_core.configs.app_configs import MOCK_CONNECTOR_FILE_PATH
from unified_core.configs.constants import DocumentSource
from unified_core.configs.constants import FileOrigin
from unified_core.configs.constants import MilestoneRecordType
from unified_core.configs.constants import ONYX_METADATA_FILENAME
from unified_core.configs.constants import OnyxCeleryPriority
from unified_core.configs.constants import OnyxCeleryTask
from unified_core.connectors.exceptions import ConnectorValidationError
from unified_core.connectors.factory import validate_ccpair_for_user
from unified_core.connectors.google_utils.google_auth import (
    get_google_oauth_creds,
)
from unified_core.connectors.google_utils.google_kv import (
...
from unified_core.connectors.google_utils.google_kv import get_auth_url
from unified_core.connectors.google_utils.google_kv import (
    get_google_app_cred,
)
from unified_core.connectors.google_utils.google_kv import (
...
from unified_core.connectors.google_utils.google_kv import verify_csrf
from unified_core.connectors.google_utils.shared_constants import DB_CREDENTIALS_DICT_TOKEN_KEY
from unified_core.connectors.google_utils.shared_constants import (
    GoogleOAuthAuthenticationMethod,
)
from unified_core.db.connector import create_connector
from unified_core.db.connector import delete_connector
from unified_core.db.connector import fetch_connector_by_id
from unified_core.db.connector import fetch_connectors
from unified_core.db.connector import get_connector_credential_ids
from unified_core.db.connector import mark_ccpair_with_indexing_trigger
from unified_core.db.connector import update_connector
from unified_core.db.connector_credential_pair import add_credential_to_connector
from unified_core.db.connector_credential_pair import (
    fetch_connector_credential_pair_for_connector,
)
from unified_core.db.connector_credential_pair import get_cc_pair_groups_for_ids
from unified_core.db.connector_credential_pair import get_connector_credential_pair
from unified_core.db.connector_credential_pair import get_connector_credential_pairs_for_user
from unified_core.db.connector_credential_pair import (
    get_connector_credential_pairs_for_user_parallel,
)
from unified_core.db.credentials import cleanup_gmail_credentials
from unified_core.db.credentials import cleanup_google_drive_credentials
from unified_core.db.credentials import create_credential
from unified_core.db.credentials import delete_service_account_credentials
from unified_core.db.credentials import fetch_credential_by_id_for_user
from unified_core.db.deletion_attempt import check_deletion_attempt_is_allowed
from unified_core.db.document import get_document_counts_for_all_cc_pairs
from unified_core.db.engine.sql_engine import get_session
from unified_core.db.enums import AccessType
from unified_core.db.enums import ConnectorCredentialPairStatus
from unified_core.db.enums import IndexingMode
from unified_core.db.federated import fetch_all_federated_connectors_parallel
from unified_core.db.index_attempt import get_index_attempts_for_cc_pair
from unified_core.db.index_attempt import get_latest_index_attempts_by_status
from unified_core.db.index_attempt import get_latest_index_attempts_parallel
from unified_core.db.models import ConnectorCredentialPair
from unified_core.db.models import FederatedConnector
from unified_core.db.models import IndexAttempt
from unified_core.db.models import IndexingStatus
from unified_core.db.models import User
from unified_core.db.models import UserRole
from unified_core.file_processing.extract_file_text import extract_file_text
from unified_core.file_store.file_store import get_default_file_store
from unified_core.file_store.models import ChatFileType
from unified_core.key_value_store.interface import KvKeyNotFoundError
from unified_core.server.documents.models import AuthStatus
from unified_core.server.documents.models import AuthUrl
from unified_core.server.documents.models import ConnectorCredentialPairIdentifier
from unified_core.server.documents.models import ConnectorIndexingStatusLite
from unified_core.server.documents.models import ConnectorIndexingStatusLiteResponse
from unified_core.server.documents.models import ConnectorSnapshot
from unified_core.server.documents.models import ConnectorStatus
from unified_core.server.documents.models import ConnectorUpdateRequest
from unified_core.server.documents.models import CredentialBase
from unified_core.server.documents.models import CredentialSnapshot
from unified_core.server.documents.models import DocsCountOperator
from unified_core.server.documents.models import FailedConnectorIndexingStatus
from unified_core.server.documents.models import FileUploadResponse
from unified_core.server.documents.models import GDriveCallback
from unified_core.server.documents.models import GmailCallback
from unified_core.server.documents.models import GoogleAppCredentials
from unified_core.server.documents.models import GoogleServiceAccountCredentialRequest
from unified_core.server.documents.models import GoogleServiceAccountKey
from unified_core.server.documents.models import IndexingStatusRequest
from unified_core.server.documents.models import ObjectCreationIdResponse
from unified_core.server.documents.models import RunConnectorRequest
from unified_core.server.documents.models import SourceSummary
from unified_core.server.federated.models import FederatedConnectorStatus
from unified_core.server.models import StatusResponse
from unified_core.server.query_and_chat.chat_utils import mime_type_to_chat_file_type
from unified_core.utils.logger import setup_logger
from unified_core.utils.telemetry import create_milestone_and_report
from unified_core.utils.threadpool_concurrency import CallableProtocol
from unified_core.utils.threadpool_concurrency import run_functions_tuples_in_parallel
...
def create_connector_from_model(
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "unified_core.db.user_group", "validate_object_creation_for_user", None
        )(
            db_session=db_session,
            user=user,
