...
from unified_core.db.federated import create_federated_connector_document_set_mapping
...
from unified_core.db.models import DocumentSet as DocumentSetDBModel
from unified_core.db.models import DocumentSet__ConnectorCredentialPair
from unified_core.db.models import DocumentSet__UserGroup
from unified_core.db.models import FederatedConnector__DocumentSet
...
from unified_core.server.features.document_set.models import DocumentSetCreationRequest
from unified_core.server.features.document_set.models import DocumentSetUpdateRequest
...
def insert_document_set(
    ...
    try:
        ...
        versioned_private_doc_set_fn = fetch_versioned_implementation(
            "unified_core.db.document_set", "make_doc_set_private"
        )
...
def mark_document_set_as_to_be_deleted(
    ...
    try:
        ...
        versioned_delete_private_fn = fetch_versioned_implementation(
            "unified_core.db.document_set", "delete_document_set_privacy__no_commit"
        )
