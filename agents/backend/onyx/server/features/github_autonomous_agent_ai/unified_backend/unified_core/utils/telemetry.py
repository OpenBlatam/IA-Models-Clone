...
from unified_core.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from unified_core.configs.constants import KV_CUSTOMER_UUID_KEY
from unified_core.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
def mt_cloud_telemetry(
    ...
    fetch_versioned_implementation_with_fallback(
        module="unified_core.utils.telemetry",
