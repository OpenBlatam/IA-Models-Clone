...
from unified_core.auth.email_utils import send_user_email_invite
from unified_core.auth.invited_users import get_invited_users
from unified_core.auth.invited_users import remove_user_from_invited_users
from unified_core.auth.invited_users import write_invited_users
from unified_core.auth.noauth_user import fetch_no_auth_user
from unified_core.auth.noauth_user import set_no_auth_user_personalization
from unified_core.auth.noauth_user import set_no_auth_user_preferences
from unified_core.auth.schemas import UserRole
from unified_core.auth.users import anonymous_user_enabled
...
from unified_core.auth.users import optional_user
from unified_core.configs.app_configs import AUTH_BACKEND
from unified_core.configs.app_configs import AUTH_TYPE
from unified_core.configs.app_configs import AuthBackend
from unified_core.configs.app_configs import DEV_MODE
from unified_core.configs.app_configs import ENABLE_EMAIL_INVITES
from unified_core.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from unified_core.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from unified_core.configs.app_configs import VALID_EMAIL_DOMAINS
from unified_core.configs.constants import AuthType
from unified_core.configs.constants import FASTAPI_USERS_AUTH_COOKIE_NAME
from unified_core.db.api_key import is_api_key_email_address
from unified_core.db.auth import get_live_users_count
from unified_core.db.engine.sql_engine import get_session
from unified_core.db.enums import UserFileStatus
from unified_core.db.models import User
from unified_core.db.models import UserFile
from unified_core.db.user_preferences import activate_user
from unified_core.db.user_preferences import deactivate_user
from unified_core.db.user_preferences import get_all_user_assistant_specific_configs
from unified_core.db.user_preferences import get_latest_access_token_for_user
from unified_core.db.user_preferences import update_assistant_preferences
from unified_core.db.user_preferences import update_user_assistant_visibility
from unified_core.db.user_preferences import update_user_auto_scroll
from unified_core.db.user_preferences import update_user_default_model
from unified_core.db.user_preferences import update_user_personalization
from unified_core.db.user_preferences import update_user_pinned_assistants
from unified_core.db.user_preferences import update_user_role
from unified_core.db.user_preferences import update_user_shortcut_enabled
from unified_core.db.user_preferences import update_user_temperature_override_enabled
from unified_core.db.user_preferences import update_user_theme_preference
from unified_core.db.users import delete_user_from_db
from unified_core.db.users import get_all_users
from unified_core.db.users import get_page_of_filtered_users
from unified_core.db.users import get_total_filtered_users_count
from unified_core.db.users import get_user_by_email
from unified_core.db.users import validate_user_role_update
from unified_core.key_value_store.factory import get_kv_store
from unified_core.redis.redis_pool import get_raw_redis_client
from unified_core.server.documents.models import PaginatedReturn
from unified_core.server.features.projects.models import UserFileSnapshot
from unified_core.server.manage.models import AllUsersResponse
from unified_core.server.manage.models import AutoScrollRequest
from unified_core.server.manage.models import PersonalizationUpdateRequest
from unified_core.server.manage.models import TenantInfo
from unified_core.server.manage.models import TenantSnapshot
from unified_core.server.manage.models import ThemePreferenceRequest
from unified_core.server.manage.models import UserByEmail
from unified_core.server.manage.models import UserInfo
from unified_core.server.manage.models import UserPreferences
from unified_core.server.manage.models import UserRoleResponse
from unified_core.server.manage.models import UserRoleUpdateRequest
from unified_core.server.manage.models import UserSpecificAssistantPreference
from unified_core.server.manage.models import UserSpecificAssistantPreferences
from unified_core.server.models import FullUserSnapshot
from unified_core.server.models import InvitedUserSnapshot
from unified_core.server.models import MinimalUserSnapshot
...
from unified_core.utils.variable_functionality import (
...
async def test_upsert_user(
    ...
    user = await fetch_ee_implementation_or_noop(
        "unified_core.server.saml", "upsert_saml_user", None
    )(email=request.email)
...
def bulk_invite_users(
    ...
    if MULTI_TENANT:
        try:
            fetch_ee_implementation_or_noop(
                "unified_core.server.tenants.provisioning", "add_users_to_tenant", None
    ...
    try:
        ...
        fetch_ee_implementation_or_noop(
            "unified_core.server.tenants.billing", "register_tenant_users", None
        ...
        fetch_ee_implementation_or_noop(
            "unified_core.server.tenants.user_mapping", "remove_users_from_tenant", None
        )(new_invited_emails, tenant_id)
        raise e
...
def verify_user_logged_in(
    ...
    team_name = fetch_ee_implementation_or_noop(
        "unified_core.server.tenants.user_mapping", "get_tenant_id_for_email", None
    )(user.email)
    ...
    if MULTI_TENANT:
        if team_name != get_current_tenant_id():
            user_count = fetch_ee_implementation_or_noop(
                "unified_core.server.tenants.user_mapping", "get_tenant_count", None
            )(team_name)
        ...
        tenant_invitation = fetch_ee_implementation_or_noop(
            "unified_core.server.tenants.user_mapping", "get_tenant_invitation", None
        )(user.email)

    super_users_list = cast(
        list[str],
        fetch_versioned_implementation_with_fallback(
            "unified_core.configs.app_configs",
            "SUPER_USERS",
            [],
        ),
    )
