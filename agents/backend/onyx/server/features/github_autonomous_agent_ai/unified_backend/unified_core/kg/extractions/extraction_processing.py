...
from unified_core.background.celery.tasks.kg_processing.utils import extend_lock
from unified_core.configs.constants import CELERY_GENERIC_BEAT_LOCK_TIMEOUT
from unified_core.db.connector import get_kg_enabled_connectors
from unified_core.db.document import get_document_updated_at
from unified_core.db.document import get_skipped_kg_documents
from unified_core.db.document import get_unprocessed_kg_document_batch_for_connector
from unified_core.db.document import update_document_kg_info
from unified_core.db.document import update_document_kg_stage
from unified_core.db.engine.sql_engine import get_session_with_current_tenant
from unified_core.db.entities import delete_from_kg_entities__no_commit
from unified_core.db.entities import upsert_staging_entity
from unified_core.db.entity_type import get_entity_types
from unified_core.db.kg_config import get_kg_config_settings
from unified_core.db.kg_config import validate_kg_settings
from unified_core.db.models import Document
from unified_core.db.models import KGStage
from unified_core.db.relationships import delete_from_kg_relationships__no_commit
from unified_core.db.relationships import upsert_staging_relationship
from unified_core.db.relationships import upsert_staging_relationship_type
from unified_core.kg.models import KGClassificationInstructions
from unified_core.kg.models import KGDocumentDeepExtractionResults
from unified_core.kg.models import KGEnhancedDocumentMetadata
from unified_core.kg.models import KGEntityTypeInstructions
from unified_core.kg.models import KGExtractionInstructions
from unified_core.kg.models import KGImpliedExtractionResults
from unified_core.kg.utils.extraction_utils import EntityTypeMetadataTracker
from unified_core.kg.utils.extraction_utils import (
    get_batch_documents_metadata,
)
from unified_core.kg.utils.extraction_utils import kg_deep_extraction
from unified_core.kg.utils.extraction_utils import (
    kg_implied_extraction,
)
from unified_core.kg.utils.formatting_utils import extract_relationship_type_id
from unified_core.kg.utils.formatting_utils import get_entity_type
from unified_core.kg.utils.formatting_utils import split_entity_id
