        ...
        >
          <motion.button 
            className={clsx(
              ...
              "text-base leading-normal disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            )}
          ...
          >
            <svg 
              ...
              aria-hidden="true"
            >
              <path d="M0 3.449L9.75 2.1v9.228H0zm10.949 0L24 0v11.4H10.949zM0 12.6h9.75v9.228L0 20.551zm10.949 0H24V24l-13.051-2.051z"/>
            </svg>
