...
from ..infrastructure.database.session import DatabaseSessionManager, get_db_manager, get_db_session

def init_database(database_url: str):
    """Initialize database connection (deprecated - use infrastructure.database.session)"""
    db_manager = get_db_manager()
    if db_manager.database_url != database_url:
...
def get_db():
    """Get database session dependency (deprecated - use infrastructure.database.session.get_db_session)"""
