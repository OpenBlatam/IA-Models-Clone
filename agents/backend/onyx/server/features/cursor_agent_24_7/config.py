...
Para nueva funcionalidad, usar core.config_manager_refactored.
"""
...
# Configuración del agente (compatibilidad hacia atrás)
AGENT_CONFIG = {
...
# Configuración de la API (compatibilidad hacia atrás)
API_CONFIG = {
...
# Configuración de Cursor API (cuando esté disponible) (compatibilidad hacia atrás)
CURSOR_API_CONFIG = {
...
# Nueva API: Usar get_config() para obtener configuración centralizada
try:
    from .core.config_manager_refactored import get_config, get_config_manager
    __all__ = [
        "AGENT_CONFIG",
        "API_CONFIG",
        "CURSOR_API_CONFIG",
