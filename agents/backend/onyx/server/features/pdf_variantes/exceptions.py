...
⚠️ DEPRECATED: This file is deprecated. Use `api/exceptions.py` instead.

For new code, use:
    from api.exceptions import BaseAPIException, ValidationError, NotFoundError
    # or
...
warnings.warn(
    "exceptions.py is deprecated. Use 'api/exceptions.py' instead.",
    DeprecationWarning,
    stacklevel=2
)
