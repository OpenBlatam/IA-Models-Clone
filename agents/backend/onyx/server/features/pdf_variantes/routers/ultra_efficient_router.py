...
⚠️ DEPRECATED: This file is deprecated. Use `api/routes.py` instead.

For new code, use:
    from api.routes import router
    # or register via api.routers.register_routers(app)
"""
import warnings

warnings.warn(
    "routers/ultra_efficient_router.py is deprecated. Use 'api/routes.py' instead.",
    DeprecationWarning,
    stacklevel=2
)
...
# Use canonical dependencies instead of deprecated enhanced_dependencies
try:
    from ..api.dependencies import get_config, get_current_user, validate_file_size
except ImportError:
    # Fallback for backward compatibility
    from ..enhanced_dependencies import get_config, get_current_user, validate_file_size
from ..models import PDFUploadRequest, VariantGenerateRequest, TopicExtractRequest
