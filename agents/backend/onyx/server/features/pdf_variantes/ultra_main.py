...
⚠️ DEPRECATED: This file is deprecated. Ultra-optimizations should be integrated
into api/main.py or added as middleware/plugins.
...
warnings.warn(
    "ultra_main.py is deprecated. Ultra-optimizations should be integrated into api/main.py.",
    DeprecationWarning,
    stacklevel=2
)
