...
⚠️ DEPRECATED: This file is deprecated. Use `models.py` instead.

For new code, use:
    from models import PDFUploadRequest, VariantGenerateRequest, PDFDocument
    # All models are in models.py
"""
import warnings

warnings.warn(
    "optimized_schemas.py is deprecated. Use 'models.py' instead for all Pydantic models.",
    DeprecationWarning,
    stacklevel=2
)
