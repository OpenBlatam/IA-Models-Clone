...
⚠️ DEPRECATED: This file is deprecated. Async utilities are available in `services/pdf_service.py`.
...
warnings.warn(
    "async_services.py is deprecated. Use 'services/pdf_service.py' instead for async operations.",
    DeprecationWarning,
    stacklevel=2
)
