...
⚠️ DEPRECATED: This file is deprecated. Optimizations should be integrated
into api/main.py or added as middleware.
...
warnings.warn(
    "optimized_main.py is deprecated. Optimizations should be integrated into api/main.py.",
    DeprecationWarning,
    stacklevel=2
)
