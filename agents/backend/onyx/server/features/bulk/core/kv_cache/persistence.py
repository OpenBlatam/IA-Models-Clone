...
class CachePersistence:
    ...
    def _extract_storage_data(self, cache: Any) -> StatsDict:
    ...
    def _restore_storage_data(self, cache: Any, storage_data: StatsDict) -> None:
...
def load_cache_checkpoint(cache: Any, checkpoint_dir: str, step: int | None = None) -> bool:
    """
