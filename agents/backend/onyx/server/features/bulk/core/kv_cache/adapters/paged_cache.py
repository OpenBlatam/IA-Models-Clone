...
from kv_cache.types import StatsDict, CacheEntry
...
class PagedKVCache(BaseKVCache):
    ...
    def __init__(self, config: KVCacheConfig):
        ...
        # Page management
        self._pages: dict[int, list[CacheEntry]] = {}
    ...
    def get_page(self, page_id: int) -> list[CacheEntry] | None:
        """
        Get entire page.
    ...
    def get_page_stats(self) -> StatsDict:
        """
        Get page statistics.
