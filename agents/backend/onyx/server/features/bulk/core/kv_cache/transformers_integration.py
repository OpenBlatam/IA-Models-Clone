...
from kv_cache.constants import DEFAULT_WARMUP_SAMPLES
...
class TransformersKVCache:
    ...
    def get_cache_stats(self) -> StatsDict:
        """Get cache statistics."""
        return self.cache.get_stats()
    
    def warmup(self, num_samples: int = DEFAULT_WARMUP_SAMPLES, seq_len: int = 128) -> None:
        """
