    ...
    def get_device_info(device: torch.device) -> dict:
        ...
        if device.type == "cuda":
            info.update({
                ...
                "cuda_device_name": torch.cuda.get_device_name(device.index or 0) if torch.cuda.is_available() else None,
                "cuda_memory_allocated": torch.cuda.memory_allocated(device.index or 0) if torch.cuda.is_available() else None,
            })
