"""
Tests refactorizados completos para todos los audio processors
...
class TestMasteringProcessorRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests refactorizados para MasteringProcessor"""
    ...
    def test_master_audio(self, mastering_processor, shape, sample_rate):
        """Test de mastering con diferentes configuraciones"""
...
class TestNoiseReducerRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests refactorizados para NoiseReducer"""
    ...
    def test_reduce_noise(self, noise_reducer, shape, sample_rate):
        """Test de reducción de ruido con diferentes configuraciones"""
...
class TestStereoConverterRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests refactorizados para StereoConverter"""
    ...
    @pytest.mark.parametrize("audio_shape,expected_shape", [
        ((1000,), (2, 1000)),
        ((44100,), (2, 44100))
    ])
    def test_convert_mono_to_stereo(self, stereo_converter, audio_shape, expected_shape):
        """Test de conversión mono a estéreo con diferentes tamaños"""
        audio = np.random.randn(*audio_shape).astype(np.float32)
...
class TestAllAudioProcessorsIntegrationRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests de integración refactorizados para todos los processors"""
