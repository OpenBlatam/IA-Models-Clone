"""
Tests refactorizados para gradient manager
...
class TestClipGradientsRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests refactorizados para clip_gradients"""
...
class TestGetGradientNormRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests refactorizados para get_gradient_norm"""
...
class TestCheckGradientsRefactored(BaseServiceTestCase, StandardTestMixin):
    """Tests refactorizados para check_gradients"""
