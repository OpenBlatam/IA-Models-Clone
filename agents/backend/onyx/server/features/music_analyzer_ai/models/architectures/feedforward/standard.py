"""
Standard Feedforward Network Module

Implements standard feedforward network with activation and dropout.
"""
...
class FeedForward(nn.Module):
    ...
    def __init__(
        ...
        logger.debug(f"Initialized FeedForward with embed_dim={embed_dim}, ff_dim={ff_dim}, activation='{activation}'")
