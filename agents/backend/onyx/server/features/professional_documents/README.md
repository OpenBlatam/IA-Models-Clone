...
├── core/              # Core functionality (API, models, services, AI, templates, config)
├── features/          # Additional features (analytics, security, monitoring, etc.)
├── experimental/      # Experimental/advanced features (blockchain, quantum, metaverse, etc.)
├── tests/             # Test files
...
### Core Module
The `core/` directory contains the essential functionality:
- `api.py` - FastAPI router and endpoints
- `models.py` - Pydantic models and data structures
- `services.py` - Core business logic (generation, export, templates)
- `ai_service.py` - AI content generation service
- `templates.py` - Document templates
- `config.py` - Configuration management

### Features Module
The `features/` directory contains additional production-ready features:
...
### Experimental Module
The `experimental/` directory contains advanced/experimental features:
...
```python
from features.professional_documents import professional_documents_router
...
```python
from features.professional_documents.core.ai_service import AIDocumentGenerator
...
### Export Directory
```python
from features.professional_documents.core.services import DocumentExportService
...
```python
from features.professional_documents.core.models import DocumentTemplate, DocumentType
from features.professional_documents.core.templates import template_manager
