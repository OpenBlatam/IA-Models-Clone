...
from unified_core.configs.app_configs import LOG_ONYX_MODEL_INTERACTIONS
from unified_core.configs.app_configs import MOCK_LLM_RESPONSE
from unified_core.configs.chat_configs import QA_TIMEOUT
from unified_core.configs.model_configs import (
    DISABLE_LITELLM_STREAMING,
)
from unified_core.configs.model_configs import GEN_AI_TEMPERATURE
from unified_core.configs.model_configs import LITELLM_EXTRA_BODY
from unified_core.llm.interfaces import LLM
from unified_core.llm.interfaces import LLMConfig
from unified_core.llm.interfaces import ToolChoiceOptions
from unified_core.llm.llm_provider_options import VERTEX_CREDENTIALS_FILE_KWARG
from unified_core.llm.llm_provider_options import VERTEX_LOCATION_KWARG
from unified_core.llm.utils import model_is_reasoning_model
from unified_core.server.utils import mask_string
...
def _convert_litellm_message_to_langchain_message(
    ...
    from unified_core.llm.litellm_singleton import litellm
