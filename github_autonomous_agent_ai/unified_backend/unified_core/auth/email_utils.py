...
from unified_core.configs.app_configs import EMAIL_FROM
from unified_core.configs.app_configs import SENDGRID_API_KEY
from unified_core.configs.app_configs import SMTP_PASS
from unified_core.configs.app_configs import SMTP_PORT
from unified_core.configs.app_configs import SMTP_SERVER
from unified_core.configs.app_configs import SMTP_USER
from unified_core.configs.app_configs import WEB_DOMAIN
from unified_core.configs.constants import AuthType
from unified_core.configs.constants import ONYX_DEFAULT_APPLICATION_NAME
from unified_core.configs.constants import ONYX_DISCORD_URL
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="unified_core.app")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    try:
        load_runtime_settings_fn = fetch_versioned_implementation(
            "unified_core.server.enterprise_settings.store", "load_runtime_settings"
        )
