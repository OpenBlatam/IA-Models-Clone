...
from unified_core.db.user_file import update_last_accessed_at_for_user_files
from unified_core.file_store.models import InMemoryChatFile
from unified_core.file_store.utils import get_user_files_as_user
from unified_core.file_store.utils import load_in_memory_chat_files
...
def parse_user_files(
    ...
    # TODO: fix this
    from unified_core.db.user_file import calculate_user_files_token_count
