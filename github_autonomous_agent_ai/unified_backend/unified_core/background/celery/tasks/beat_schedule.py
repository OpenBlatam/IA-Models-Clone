...
from unified_core.configs.app_configs import LLM_MODEL_UPDATE_API_URL
...
beat_task_templates: list[dict] = [
    ...
    {
        "name": "check-continuous-agents",
        "task": OnyxCeleryTask.CHECK_CONTINUOUS_AGENTS_TASK,
        "schedule": timedelta(seconds=60),  # Check every minute
        "options": {
            "priority": OnyxCeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
        },
