...
from unified_core.configs.app_configs import GOOGLE_DRIVE_CONNECTOR_SIZE_THRESHOLD
from unified_core.configs.app_configs import INDEX_BATCH_SIZE
from unified_core.configs.app_configs import MAX_DRIVE_WORKERS
...
from unified_core.connectors.exceptions import CredentialExpiredError
from unified_core.connectors.exceptions import InsufficientPermissionsError
from unified_core.connectors.google_drive.doc_conversion import build_slim_document
from unified_core.connectors.google_drive.doc_conversion import (
    convert_drive_item_to_document,
)
from unified_core.connectors.google_drive.doc_conversion import onyx_document_id_from_drive_file
from unified_core.connectors.google_drive.doc_conversion import PermissionSyncContext
from unified_core.connectors.google_drive.file_retrieval import crawl_folders_for_files
from unified_core.connectors.google_drive.file_retrieval import DriveFileFieldType
from unified_core.connectors.google_drive.file_retrieval import get_all_files_for_oauth
from unified_core.connectors.google_drive.file_retrieval import (
    get_all_files_in_my_drive_and_shared,
)
from unified_core.connectors.google_drive.file_retrieval import get_files_in_shared_drive
from unified_core.connectors.google_drive.file_retrieval import get_root_folder_id
from unified_core.connectors.google_drive.models import DriveRetrievalStage
from unified_core.connectors.google_drive.models import GoogleDriveCheckpoint
from unified_core.connectors.google_drive.models import GoogleDriveFileType
from unified_core.connectors.google_drive.models import RetrievedDriveFile
from unified_core.connectors.google_drive.models import StageCompletion
from unified_core.connectors.google_utils.google_auth import get_google_creds
from unified_core.connectors.google_utils.google_utils import execute_paginated_retrieval
from unified_core.connectors.google_utils.google_utils import get_file_owners
from unified_core.connectors.google_utils.google_utils import GoogleFields
from unified_core.connectors.google_utils.resources import get_admin_service
from unified_core.connectors.google_utils.resources import get_drive_service
from unified_core.connectors.google_utils.resources import GoogleDriveService
from unified_core.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_PRIMARY_ADMIN_KEY,
)
from unified_core.connectors.google_utils.shared_constants import MISSING_SCOPES_ERROR_STR
from unified_core.connectors.google_utils.shared_constants import ONYX_SCOPE_INSTRUCTIONS
from unified_core.connectors.google_utils.shared_constants import SLIM_BATCH_SIZE
from unified_core.connectors.google_utils.shared_constants import USER_FIELDS
from unified_core.connectors.interfaces import CheckpointedConnectorWithPermSync
from unified_core.connectors.interfaces import CheckpointOutput
from unified_core.connectors.interfaces import GenerateSlimDocumentOutput
from unified_core.connectors.interfaces import SecondsSinceUnixEpoch
from unified_core.connectors.interfaces import SlimConnectorWithPermSync
from unified_core.connectors.models import ConnectorFailure
from unified_core.connectors.models import ConnectorMissingCredentialError
from unified_core.connectors.models import Document
from unified_core.connectors.models import EntityFailure
...
from unified_core.utils.retry_wrapper import retry_builder
from unified_core.utils.threadpool_concurrency import parallel_yield
from unified_core.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from unified_core.utils.threadpool_concurrency import ThreadSafeDict
