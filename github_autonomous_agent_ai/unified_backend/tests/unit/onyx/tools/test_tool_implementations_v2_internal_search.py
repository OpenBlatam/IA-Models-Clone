...
from unified_core.chat.turn.infra.emitter import Emitter
...
from unified_core.server.query_and_chat.streaming_models import SavedSearchDoc
...
def run_internal_search_core_with_dependencies(
    ...
    from unified_core.tools.tool_implementations_v2.internal_search import _internal_search_core

    # Patch the dependencies that the real function uses
    with patch(
        "unified_core.tools.tool_implementations_v2.internal_search.get_session_with_current_tenant"
    ) as mock_get_session, patch(
        "unified_core.tools.tool_implementations_v2.internal_search.get_tool_by_name"
