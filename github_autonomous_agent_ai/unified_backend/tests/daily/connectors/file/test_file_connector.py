...
@patch("unified_core.connectors.file.connector.get_default_file_store")
@patch(
    "unified_core.file_processing.extract_file_text.get_unstructured_api_key", return_value=None
)
def test_single_text_file_with_metadata(
    ...
    with patch(
        "unified_core.connectors.file.connector.get_default_file_store",
