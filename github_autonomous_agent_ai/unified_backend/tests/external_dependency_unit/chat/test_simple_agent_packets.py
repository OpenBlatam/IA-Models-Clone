...
from unified_core.feature_flags.interface import FeatureFlagProvider
...
def test_simple_agent_with_search_and_fetch_packets(
    ...
    with patch(
        "unified_core.server.query_and_chat.streaming_utils.get_default_feature_flag_provider"
