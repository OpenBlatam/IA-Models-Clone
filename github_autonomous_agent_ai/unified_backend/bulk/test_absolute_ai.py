"""
Test script for BUL Absolute AI System
=====================================
...
def test_bul_system():
    """Test the BUL system endpoints."""
    base_url = "http://localhost:8000"
    
    print("=" * 60)
    print("BUL - Business Universal Language (Absolute AI)")
    print("System Test")
    print("=" * 60)
    print()
    ...
    try:
        ...
        response = requests.get(f"{base_url}/ai/absolute-models", timeout=10)
        if response.status_code == 200:
            data = response.json()
        ...
        print("BUL Absolute AI System is working correctly.")
        print("=" * 60)
        return True
        
    except requests.exceptions.ConnectionError:
        print("❌ Connection Error: Could not connect to the BUL system.")
...
def main():
    """Main function."""
    print("Starting BUL Absolute AI System Test...")
    print(f"Test started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print()
    
    success = test_bul_system()
